...
annFile='/home/hqvo2/Projects/Breast_Cancer/data/processed_data/mass/test/annotation_coco_with_classes.json'
cocoGt=CocoApi(annFile);

%% initialize COCO detections api
% resFile='%s/results/%s_%s_fake%s100_results.json';
resFile='/home/hqvo2/Projects/Breast_Cancer/libs/mmdetection/result.bbox.json'
...
I = imread(sprintf('/home/hqvo2/Datasets/processed_data/mass/test/%s',img.file_name));
